                ...
                <div class="p-6">
                    @if($grades->count() > 0)
                        ...
                        <div class="mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Academic Summary</h4>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Total Courses</p>
                                    <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $grades->count() }}</p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Graded Courses</p>
                                    <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $grades->whereNotNull('grade')->count() }}</p>
                                </div>
                                <div>
